                ...
                link: function (scope, element, attrs) {
                  ...
                  //  return;
                    ...
                    var onlongpress = function(evt) {
                        ...
                        $rootScope.$broadcast('checkMouseDown:position',{x:_mx, y:_my, tx:_tx, ty:_ty, event:evt, element:element, data:_data});
                    ...
                    var onrelease = function(evt) {
                        if(! _dragEnabled)return;
                        evt.preventDefault();
                        $rootScope.$broadcast("checkMouseUp:position",{x:_mx, y:_my, tx:_tx, ty:_ty, event:evt, element:element, data:_data, callback:onDragComplete});
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var toggleListeners = function (enable) {
                        ...
                        scope.$on('$destroy', onDestroy);
                        scope.$on('checkMouseDown:position',function (evt,obj){
                            mousedown_x = obj.x;
                            mousedown_y = obj.y;
                        });
                        scope.$on('checkMouseDown:position',function (evt,obj){
                    ...
                    var onDragStart = function(evt, obj) {
                        var x = mousedown_x - mouseup_x;
                        var y = mousedown_y - mouseup_y;
                        console.log(mousedown_x + ">"+mouseup_x)
